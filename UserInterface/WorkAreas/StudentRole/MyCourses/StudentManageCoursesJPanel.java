...
public class StudentManageCoursesJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tblCoursesHistory.getColumnModel().getColumnCount() > 0) {
            tblCoursesHistory.getColumnModel().getColumn(2).setResizable(false);
            tblCoursesHistory.getColumnModel().getColumn(3).setResizable(false);
        }
